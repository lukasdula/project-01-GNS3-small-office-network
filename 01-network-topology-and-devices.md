...
| :------------------------------ | :----------------------------------------------------- | :--------------------------------- | :------------- | :---------------------------------------------------------------------------------- |
| **Router R1**                   | Cisco vIOS (vios-adventerprisek9-m.spa.159-3.m6.qcow2) | 6 adapters (GigabitEthernet ports) | Native console | Layer 3 routing device; inter-VLAN routing; NAT/PAT; gateway to ISP.                |
| **ISP Router**                  | Cisco vIOS (same image)                                | 6 adapters (GigabitEthernet ports) | Native console | Layer 3 routing device; simulated ISP router providing WAN access.                  |
| **Switches SW1–SW3**            | Cisco vIOS-L2 (viosl2-adventerprisek9-m-15.2)          | 4 adapters (Ethernet) each         | Native console | Layer 2 switching; access ports and trunk links across host segments.               |
